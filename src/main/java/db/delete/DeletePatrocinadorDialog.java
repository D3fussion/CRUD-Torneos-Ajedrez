 ...
 * @author Maestro
 */
public class DeletePatrocinadorDialog extends javax.swing.JInternalFrame {
     ...
     */
    public DeletePatrocinadorDialog(java.awt.Frame parent, Database db, JDesktopPane desktopPane) {
    ...
    private void buildCombo() {
        final String sql = "SELECT sponsor_id, sponsor_name FROM List_of_Sponsors ORDER BY sponsor_id";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String sponsor_name= rs.getString(2);
                // Agregar nombre del proveedor al combo
                comboProveedor.addItem(id+" : "+sponsor_name);
                values.add("sponsor_id= \""+id+"\" : sponsor_name =\""+sponsor_name+"\"");
                i++;
            }
            if (i == 0) {
                JOptionPane.showInternalMessageDialog(this, "No sponsors found", "Error", JOptionPane.ERROR_MESSAGE);
                doClose(RET_CANCEL);
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sponsor ID and Name:");
...
//            String[] valores= comboProveedor.getSelectedItem().toString().split("\"");
            ...
            //String id = ;
            String sql = String.format("DELETE FROM List_of_Sponsors WHERE sponsor_id = \'%s\'",valores[1]);
            System.out.println(sql);
            db.update(sql);
            cambios++;
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showInternalMessageDialog(this, "Error trying to delete sponsor", "Error", JOptionPane.ERROR_MESSAGE);
