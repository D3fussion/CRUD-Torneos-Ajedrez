 ...
 * @author Maestro
 */
public class DeleteResultDialog extends javax.swing.JInternalFrame {
     ...
     */
    public DeleteResultDialog(java.awt.Frame parent, Database db, JDesktopPane desktopPane) {
    ...
    private void buildCombo() {
        final String sql = "SELECT result_code, result_description FROM Ref_Result_Codes ORDER BY result_code";
        ...
        try {
            ...
            if (i == 0) {
                JOptionPane.showInternalMessageDialog(this, "No result codes found", "Error", JOptionPane.ERROR_MESSAGE);
                doClose(RET_CANCEL);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Eliminate Result Code");
        setResizable(false);
        ...
        jLabel1.setText("Result Code and Description:");
...
//            String[] valores= comboProveedor.getSelectedItem().toString().split("\"");
            ...
            //String id = ;
            String sql = String.format("DELETE FROM Ref_Result_Codes WHERE result_code = \'%s\'",valores[1]);
