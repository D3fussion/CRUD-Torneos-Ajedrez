 ...
 * @author Maestro
 */
public class DeleteTorneoDialog extends javax.swing.JInternalFrame {
     ...
     */
    public DeleteTorneoDialog(java.awt.Frame parent, Database db, JDesktopPane desktopPane) {
    ...
    private void buildCombo() {
        final String sql = "SELECT tournament_id, tournament_name FROM Tournaments ORDER BY tournament_id";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String tournament_name= rs.getString(2);

                comboProveedor.addItem(id+" : "+tournament_name);
                values.add("tournament_id= \""+id+"\" : tournament_name = \""+tournament_name+"\"");
                i++;
            }
            if (i == 0) {
                JOptionPane.showInternalMessageDialog(this, "No tournaments found", "Error", JOptionPane.ERROR_MESSAGE);
                doClose(RET_CANCEL);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Eliminate Tournaments");
        setResizable(false);
        ...
        jLabel1.setText("Tournament ID and Name:");
...
//            String[] valores =  comboProveedor.getSelectedItem().toString().split("\"");
            ...
            String sql = String.format("DELETE FROM Tournaments WHERE tournament_id = \'%s\'",valores[1]);
            System.out.println(sql);
            db.update(sql);
            cambios++;
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showInternalMessageDialog(this, "Error trying to delete tournament", "Error", JOptionPane.ERROR_MESSAGE);
