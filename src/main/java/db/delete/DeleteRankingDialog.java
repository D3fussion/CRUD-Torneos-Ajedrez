 ...
 * @author Maestro
 */
public class DeleteRankingDialog extends javax.swing.JInternalFrame {
     ...
     */
    public DeleteRankingDialog(java.awt.Frame parent, Database db, JDesktopPane desktopPane) {
    ...
    private void buildCombo() {
        final String sql = "SELECT ranking_code, ranking_description FROM Ref_Ranking_Codes ORDER BY ranking_code";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                comboProveedor.addItem(code+" : "+description);
                values.add("code= \""+code+"\" : description =\""+description+"\"");
                i++;
            }
            if (i == 0) {
                JOptionPane.showInternalMessageDialog(this, "No ranking codes found", "Error", JOptionPane.ERROR_MESSAGE);
                doClose(RET_CANCEL);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Eliminate Ranking Code");
        setResizable(false);
        ...
        jLabel1.setText("Ranking Code and Description:");
...
//            String[] valores= comboProveedor.getSelectedItem().toString().split("\"");
            ...
            //String id = ;
            String sql = String.format("DELETE FROM Ref_Ranking_Codes WHERE ranking_code = \'%s\'",valores[1]);
            System.out.println(sql);
            db.update(sql);
            cambios++;
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showInternalMessageDialog(this, "Error trying to delete ranking code", "Error", JOptionPane.ERROR_MESSAGE);
        }
