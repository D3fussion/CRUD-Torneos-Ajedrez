 ...
 * @author Maestro
 */
public class DeleteTornPatroDialog extends javax.swing.JInternalFrame {
     ...
     */
    public DeleteTornPatroDialog(java.awt.Frame parent, Database db, JDesktopPane desktopPane) {
    ...
    private void buildCombo() {
        final String sql = "SELECT tournament_id, sponsor_id FROM Actual_Tournament_Sponsors ORDER BY tournament_id";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String sponsor_id= rs.getString(2);
                // Agregar nombre del proveedor al combo
                comboProveedor.addItem("Tournament "+id+" | Sponsor "+sponsor_id+"");
                values.add("tournament_id= \""+id+"\" : sponsor_id = \""+sponsor_id+"\"");
                i++;
            }
            if (i == 0) {
                JOptionPane.showInternalMessageDialog(this, "No tournament sponsors found", "Error", JOptionPane.ERROR_MESSAGE);
                doClose(RET_CANCEL);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Eliminate Tournament Sponsors");
        setResizable(false);
        ...
        jLabel1.setText("Tournament ID and Sponsor ID:");
...
//            String[] valores =  comboProveedor.getSelectedItem().toString().split("\"");
            ...
            String sql = String.format("DELETE FROM Actual_Tournament_Sponsors WHERE tournament_id = \'%s\' AND sponsor_id = \'%s\'",valores[1],valores[3]);
            System.out.println(sql);
            db.update(sql);
            cambios++;
        } catch (SQLException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showInternalMessageDialog(this, "Error trying to delete tournament sponsor", "Error", JOptionPane.ERROR_MESSAGE);
