...
public class InsertTornamentSponsor extends javax.swing.JInternalFrame {

    private final HashMap htTorneoID, htPatroID;
    private final Database db;
    private String pk = "";
    JDesktopPane desktopPane;
    int cambios = 0;

    public InsertTornamentSponsor(Database db, JDesktopPane desktopPane)  {
    ...
    private void buildComboPatroID(Database db) {
        final String sql = "select sponsor_id, sponsor_name FROM List_of_Sponsors";
...
//                }
                ...
                // Agregar nombre del proveedor al combo
                comboPatroID.addItem(label);
                // Guardar nombre y ID del proveedor
                htPatroID.put(label, id);
            }
        } catch (SQLException ex) {
            System.out.println(ex);
        }
    ...
    private void initComponents() {
        ...
        comboPatroID = new javax.swing.JComboBox<>();


        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Add Tour. Sponsor");
        setResizable(false);
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(27, 27, 27) // Margen izquierdo labels
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(jLabel1)
                                                        .addComponent(jLabel2))
                                                .addGap(17, 17, 17) // Margen izquierdo combo
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addComponent(comboPatroID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                )))
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        Integer patro_id = (Integer) htPatroID.get(comboPatroID.getSelectedItem());


        StringBuilder sql
                = new StringBuilder("INSERT INTO Actual_Tournament_Sponsors (sponsor_id, tournament_id) VALUES (");
        sql.append(patro_id);
        sql.append(",\'");
        ...
        try {
            ...
            JOptionPane.showInternalMessageDialog(desktopPane, "Error inserting tournament sponsor\nThe previous changes will not be applied", "Error", JOptionPane.ERROR_MESSAGE);
            try {
                db.con.rollback();
        ...
        comboPatroID.setSelectedIndex(0);
    ...
    private javax.swing.JComboBox<String> comboPatroID;
