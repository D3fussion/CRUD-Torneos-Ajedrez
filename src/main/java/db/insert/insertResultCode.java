...
public class insertResultCode extends javax.swing.JInternalFrame {
    ...
    public insertResultCode(Database db, JDesktopPane desktopPane) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if(checkValidFields(textFields)) {
            ...
            StringBuilder sql
                    = new StringBuilder("INSERT INTO Ref_Result_Codes (result_code, result_description) VALUES (");
            sql.append(codigo);
            sql.append(",\'");
            ...
            if(descripcion.equals("Win") || descripcion.equals("Lose") || descripcion.equals("Draw")){
                try {
                    db.update(sql.toString());
                    cambios++;
                } catch (SQLException ex) {
                    JOptionPane.showInternalMessageDialog(this, "Error inserting the ranking code.\nThis could be because the ranking code already exists.\nThe previous changes will not be applied", "Error", JOptionPane.ERROR_MESSAGE);
                    try {
                        db.con.rollback();
                ...
                JOptionPane.showInternalMessageDialog(this, "The description must be Win, Lose or Draw.", "Error", JOptionPane.ERROR_MESSAGE);
            }
